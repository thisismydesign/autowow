...
Gem::Specification.new do |spec|
  ...
  spec.add_dependency "tty-command", "~> 0.8"         # Execute system commands nicely, upper limit because `Autowow::Executor` hijacks Printer classes (new releases should be tested)
