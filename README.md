...
*You are viewing the README of version [v0.9.6](https://github.com/thisismydesign/autowow/releases/tag/v0.9.6). You can find other releases [here](https://github.com/thisismydesign/autowow/releases).*
