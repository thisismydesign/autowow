...
*You are viewing the README of the development version. You can find the README of the latest v0.9.0 release [here](https://github.com/thisismydesign/autowow/releases/tag/v0.9.0).*
