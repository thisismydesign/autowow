...
*You are viewing the README of the development version. You can find the README of the latest release (v0.13.2) [here](https://github.com/thisismydesign/autowow/releases/tag/v0.13.2).*
